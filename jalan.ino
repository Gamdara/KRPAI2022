...
const int leg[6][2] = { {4,3},{7,2},{13,4},{9,3},{5,10},{6,8} };  //2,5
/*
...
const int pos_paha=512;  //525
const int pos_betis=512; //500

//--- delay
int  del=130; // delay dorong12
int  del2=130; // delay angkat 25
int  del3=100;
int  del4=500;
...
void init_bot() {
  for(int i=2;i<14;i++){
      ax12a.move(i,512); // set ke 500 semua
      //delay(0);
  }
}
...
// void naik() {
//     ax12a.move(leg[0][betis],pos_betis+130);
//     delay(del2);
//     ax12a.move(leg[0][paha],pos_paha+60);
//     delay(del2);
//     ax12a.move(leg[3][betis],pos_betis+130);
//     delay(del2);
//     ax12a.move(leg[2][betis],pos_betis+130);
//     delay(del2);
//     ax12a.move(leg[3][betis],pos_betis+105 );
//     delay(del2);
// }
